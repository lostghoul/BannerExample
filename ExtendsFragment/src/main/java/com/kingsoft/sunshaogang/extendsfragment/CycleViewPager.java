package com.kingsoft.sunshaogang.extendsfragment;

/**
 * Created by sunshaogang on 9/2/15.
 */
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void setData(List<ImageView> views, List<AdDomain> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<AdDomain> list, ImageCycleViewListener listener, int showPosition) {
    ...
    public static interface ImageCycleViewListener {
         ...
         * @param imageView
         */
        public void onImageClick(AdDomain info, int postion, View imageView);
    }
}
